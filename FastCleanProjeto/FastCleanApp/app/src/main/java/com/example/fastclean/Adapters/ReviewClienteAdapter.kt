...
class ReviewClienteAdapter(context : Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {


    private var context = context
    private var reviews = ArrayList<ClienteReview>()
     ...
     */
    fun setReviewList(reviewList: ArrayList<ClienteReview>){
